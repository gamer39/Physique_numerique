...
from FTCS import FTCS_temporel, FTCS_temporel_cyl, FTCS_cart_convergence
...
# ax1.set_title('B')
# ax0.pcolormesh(T_3D[:, y_plan, :].transpose(), cmap=plt.cm.                                                                                                                   )
# ax1.pcolormesh(T_3D_v2[:, y_plan, :].transpose(), cmap=plt.cm.jet)
# plt.show()

# précision = 1e-3
# T_convergence, temps, iter, sum_matrix = FTCS_cart_convergence(T_3D, T_3D_v2, précision,largeur, longueur, hauteur, alpha, delta_t, delta_x, largeur_mur)

# print('Temps=', temps, 'secondes')
# print(iter, 'itérations')
# print('sum_matrix', sum_matrix, 'kJ')
# print('q', sum_matrix/iter, 'kW')
